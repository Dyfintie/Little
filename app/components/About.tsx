          ...
          <div className="flex flex-col md:flex-row bg-gradient-to-r from-orange-200 to-orange-100">
            ...
            <div className="w-full md:w-1/2 p-6 md:p-8 lg:p-10 bg-gradient-to-r from-orange-200 to-orange-100">
              ...
              <p className="mt-4 text-orange-700 text-lg leading-relaxed from-orange-200 to-orange-100">
                ...
                exquisite North Indian delicacies, pour their heart and soul
                into every meal. We source the finest ingredients and use
                time-honored recipes to create dishes that not only satisfy your
                palate but also transport you to the vibrant streets of North
                India.
              </p>
              <p className="mt-4 text-orange-700 text-lg leading-relaxed from-orange-200 to-orange-100">
                From our aromatic curries to our freshly baked naan, every item
                on our menu is a testament to our commitment to quality and
                authenticity. We invite you to join us for a culinary journey
                that celebrates the rich tapestry of North Indian cuisine, right
                here at Little Cafe.
              </p>
            </div>
          </div>
